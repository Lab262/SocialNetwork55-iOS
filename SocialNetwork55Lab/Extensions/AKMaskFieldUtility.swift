...
class AKMaskFieldUtility {
  ...
  class func replace( sourceString: inout String!, withString string: String, inRange range: NSRange) {
  ...
  class func replacingOccurrencesOfString( string: inout String!, target: String, withString replacement: String) {    
